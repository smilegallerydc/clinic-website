      ...
      <div className="columns-1 sm:columns-2 lg:columns-3 gap-6 space-y-6">
        {galleryImages.map((img, index) => (
          <motion.div
            ...
            className="break-inside-avoid rounded-[1.5rem] overflow-hidden border border-slate-100 shadow-sm hover:shadow-lg hover:border-primary/20 transition-all duration-300 cursor-zoom-in group bg-slate-50 flex flex-col justify-start relative mb-6"
          >
