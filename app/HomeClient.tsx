                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10 py-8">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8 items-center">
                        ...
                        >
                            ...
                            <motion.h1
                                variants={heroItem}
                                className="font-display font-extrabold text-4xl sm:text-5xl lg:text-6xl leading-[1.08] tracking-tight text-slate-900"
                            >
                                Elevating the <br />
                            ...
                            >
                                Welcome to Smile Gallery Dental Clinic, Borivali
                                West. Led by Dr. Hetal Chheda, we combine expert
                                artistry, painless laser procedures, and
                                implants to give you the perfect smile.
                            </motion.p>
                            ...
                            >
                                <div className="flex -space-x-3">
                                    <div className="w-10 h-10 rounded-full border-2 border-white bg-teal-50 text-primary flex items-center justify-center font-bold text-xs">
                                        SJ
                                    </div>
                                    <div className="w-10 h-10 rounded-full border-2 border-white bg-amber-50 text-accent flex items-center justify-center font-bold text-xs">
                                        MC
                                    </div>
                                    <div className="w-10 h-10 rounded-full border-2 border-white bg-indigo-50 text-indigo-700 flex items-center justify-center font-bold text-xs">
                                        ER
                                    </div>
                                </div>
                                <div>
                                    ...
                                    >
                                        <div className="flex items-center gap-0.5">
                                            ...
                                            <span className="text-slate-800 text-sm font-bold ml-1.5 group-hover:text-primary transition-colors">
                                                4.9/5 (180+ Google Reviews)
                                            </span>
                                        </div>
                                        <p className="text-slate-500 text-xs mt-0.5 group-hover:underline decoration-primary">
                                            Verified patient ratings on Google
                                            Maps
                                        </p>
                                    </a>
                                </div>
                            ...
                            <motion.div
                                variants={heroItem}
                                className="flex flex-col gap-2 pt-2 text-left"
                            >
                                ...
                                <div className="flex flex-wrap items-center gap-3">
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-full border border-slate-100 bg-slate-50 hover:bg-[#E1306C]/5 hover:border-[#E1306C]/30 text-slate-600 hover:text-[#E1306C] text-xs font-semibold transition-all duration-300 shadow-sm"
                                    >
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-full border border-slate-100 bg-slate-50 hover:bg-[#1877F2]/5 hover:border-[#1877F2]/30 text-slate-600 hover:text-[#1877F2] text-xs font-semibold transition-all duration-300 shadow-sm"
                                    >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        >
                            <div className="space-y-4">
                                <div className="w-12 h-12 rounded-2xl bg-teal-50 text-primary flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                                    ...
                                    >
                                        <path
                                            strokeLinecap="round"
                                            strokeLinejoin="round"
                                            d="M17.5 12h-11m11 0a4.5 4.5 0 11-9 0m9 0c0-1.2-.4-2.4-1.2-3.3L12 3.5 6.7 8.7c-.8.9-1.2 2.1-1.2 3.3m12 0H6.5M12 12v9m-2-6h4m-3 3h2"
                                        />
                                    </svg>
                                </div>
                                ...
                                <p className="text-slate-500 text-sm leading-relaxed">
                                    The gold standard for replacing missing teeth. Led by Dr. Hetal Chheda, we offer single-stage implants, fixed teeth in 7 days, and full mouth rehabilitation with advanced international credentials.
                                </p>
                            </div>
                            <Link
                                href="/services"
                        ...
                        >
                            <div className="space-y-4">
                                ...
                                <p className="text-slate-500 text-sm leading-relaxed">
                                    Straighten your teeth comfortably and discreetly. We are a certified Invisalign® Provider, offering customized, virtually invisible medical-grade aligners using advanced 3D scanning.
                                </p>
                            </div>
                            <Link
                                href="/services"
                        ...
                        >
                            <div className="space-y-4">
                                ...
                                <p className="text-slate-500 text-sm leading-relaxed">
                                    Design the smile of your dreams and preserve your natural teeth. We offer custom porcelain veneers, laser teeth whitening, rotary root canals, and modern preventive therapies.
                                </p>
                            </div>
                            <Link
                                href="/services"
